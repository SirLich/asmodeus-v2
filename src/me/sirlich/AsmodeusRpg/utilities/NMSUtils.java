...
public class NMSUtils
{
     ...
     * <p>
     * If you're using a custom entity class, remember to <rpgEntity>register</rpgEntity> it before using this! Otherwise it'll not be
     ...
     * <p>
     * <p>
     * <rpgEntity>Note: </rpgEntity>Since no mob Type can be provided, overriding default mobs is not possible.
     *
    ...
    public enum MobMeta
    {
         ...
         * <p>
         * <rpgEntity>Undefined will not be accepted and returns null.</rpgEntity>
         * </p>
         */
