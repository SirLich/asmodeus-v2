...
public final class Range<T> implements Serializable
{
    ...
    public Range(T var1, T var2, Comparator<T> var3)
    {
    ...
    public Range<T> intersectionWith(Range<T> var1)
    {
        if (!this.isOverlappedBy(var1)) {
            ...
            T var2 = this.getComparator().compare(this.minimum, var1.minimum) < 0 ? var1.minimum : this.minimum;
            T var3 = this.getComparator().compare(this.maximum, var1.maximum) < 0 ? this.maximum : var1.maximum;
    ...
    public double getRandomDouble()
    {
        if (this.minimum instanceof Double) {
            Random random = new Random();
            return ThreadLocalRandom.current().nextDouble((Double) this.minimum, (Double) this.maximum);
        }
        return 0;
    }
